...
using SatisServer.UI.Data.Endpoints.PasswordlessLogin;
using SatisServer.UI.Data.Endpoints.RunCommand;
using SatisServer.UI.Data.Endpoints.UploadSave;
using SatisServer.UI.Data.Endpoints.ClaimServer;
using SatisServer.UI.Data.Endpoints.SetClientPassword;
using SatisServer.UI.Data.Endpoints.GetServerState;
using SatisServer.UI.Data.Enums;
using SatisServer.UI.Data.Endpoints.LoadSave;
using SatisServer.UI.Data.Endpoints.DownloadSave;
using SatisServer.UI.Data.Endpoints.DeleteSaveSession;
using SatisServer.UI.Data.Endpoints.ApplyServerOptions;
using SatisServer.UI.Data.Endpoints.EnumerateSessions;
using SatisServer.UI.Data.Endpoints.CreateNewGame;
using SatisServer.UI.Data.Endpoints.PasswordLogin;
using SatisServer.UI.Data.Endpoints.SaveGame;
using SatisServer.UI.Data.Endpoints.GetServerOptions;
using SatisServer.UI.Data.Endpoints.ApplyAdvancedGameSettings;
using SatisServer.UI.Data.Endpoints.GetAdvancedGameSettings;
using SatisServer.UI.Data.Endpoints.HealthCheck;
using SatisServer.UI.Data.Endpoints.DeleteSaveFile;
using SatisServer.UI.Data.Endpoints.RenameServer;
using SatisServer.UI.Data.Endpoints.AutoLoadSessionName;
using SatisServer.UI.Data.Endpoints.SetAdminPassword;

namespace SatisServer.UI.Logic;

/// <summary>Wrapper class for the Dedicated Server API</summary>
public static class ApiFunctions
{
    #region APIs
    /// <summary>Performs a health check on the Dedicated Server API. Allows passing additional data between Modded Dedicated Server and Modded Game Client.</summary>
    /// <remarks>Does not require any privileges</remarks>
    ...
    /// <summary>Verifies the Authentication token provided to the Dedicated Server API.</summary>
    /// <param name="apiClient">The API Client to use</param>
    ...
    /// <summary>
    /// <para>Attempts to perform a passwordless login to the Dedicated Server as a player.</para>
    /// <para>Passwordless login is possible if the Dedicated Server is not claimed, or if Client Protection Password is not set for the Dedicated Server.</para>
    /// </summary>
    /// <remarks>Does not require any privileges</remarks>
    /// <param name="apiClient">The API Client to use</param>
    ...
    /// <summary>Attempts to log in to the Dedicated Server as a player using either Admin Password or Client Protection Password.</summary>
    /// <remarks>Does not require any privileges</remarks>
    /// <param name="apiClient">The API Client to use</param>
    ...
    /// <remarks>Require authenticated token</remarks>
    /// <param name="apiClient">The API Client to use</param>
    ...
    /// <summary>Retrieves currently applied server options and server options that are still pending application (because of needing session or server restart)</summary>
    /// <remarks>Require admin privileges</remarks>
    /// <param name="apiClient">The API Client to use</param>
    ...
    /// <summary>Retrieves currently applied advanced game settings. Does not require input parameters.</summary>
    /// <remarks>Require admin privileges</remarks>
    /// <param name="apiClient">The API Client to use</param>
    ...
    /// <summary>
    /// <para>Applies new values to the provided Advanced Game Settings properties.</para>
    /// <para>Will automatically enable Advanced Game Settings for the currently loaded save if they are not enabled already.</para>
    /// </summary>
    /// <remarks>Require admin privileges</remarks>
    /// <param name="apiClient">The API Client to use</param>
    ...
    /// <summary>Claims this Dedicated Server if it is not claimed. </summary>
    /// <remarks>Requires InitialAdmin privilege level, which can only be acquired by attempting passwordless login while the server does not have an Admin Password set, e.g. it is not claimed yet.</remarks>
    /// <param name="apiClient">The API Client to use</param>
    ...
    /// <summary>Renames the Dedicated Server once it has been claimed.</summary>
    ...
    /// <summary>
    /// <para>Updates the currently set Client Protection Password. This will invalidate all previously issued Client authentication tokens.</para>
    /// <para>Pass empty string to remove the password, and let anyone join the server as Client.</para>
    /// </summary>
    /// <remarks>Requires Admin privileges.</remarks>
    /// <param name="apiClient">The API Client to use</param>
    ...
    /// <summary>Updates the currently set Admin Password. This will invalidate all previously issued Client and Admin authentication tokens.</summary>
    /// <remarks>Requires Admin privileges.</remarks>
    /// <param name="apiClient">The API Client to use</param>
    ...
    /// <summary>Updates the name of the session that the Dedicated Server will automatically load on startup. Does not change currently loaded session.</summary>
    /// <remarks>Requires Admin privileges.</remarks>
    /// <param name="apiClient">The API Client to use</param>
    ...
    /// <summary>Runs the given Console Command on the Dedicated Server, and returns it's output to the Console.</summary>
    /// <remarks>Requires Admin privileges.</remarks>
    /// <param name="apiClient">The API Client to use</param>
    ...
    /// <summary>Shuts down the Dedicated Server. If automatic restart script is setup, this allows restarting the server to apply new settings or update.</summary>
    /// <remarks>Requires Admin privileges. Shutdowns initiated by remote hosts are logged with their IP and their token.</remarks>
    /// <param name="apiClient">The API Client to use</param>
    ...
    /// <summary>Applies new Server Options to the Dedicated Server.</summary>
    /// <remarks>Requires Admin privileges.</remarks>
    /// <param name="apiClient">The API Client to use</param>
    ...
    /// <summary>
    /// <para>Creates a new session on the Dedicated Server, and immediately loads it.</para>
    /// <para>HTTPS API becomes temporarily unavailable when map loading is in progress</para>
    /// </summary>
    /// <remarks>Requires Admin privileges.</remarks>
    /// <param name="apiClient">The API Client to use</param>
    ...
    /// <summary>Saves the currently loaded session into the new save game file named as the argument.</summary>
    /// <remarks>Requires Admin privileges. SaveName might be changed to satisfy file system restrictions on file names.</remarks>
    /// <param name="apiClient">The API Client to use</param>
    ...
    /// <summary>Deletes the existing save game file from the server.</summary>
    /// <remarks>Requires Admin privileges. SaveName might be changed to satisfy file system restrictions on file names.</remarks>
    /// <param name="apiClient">The API Client to use</param>
    ...
    /// <summary>Deletes all save files belonging to the specific session name.</summary>
    /// <remarks>Requires Admin privileges. SessionName must be a valid session name with at least one saved save game file belonging to it.</remarks>
    /// <param name="apiClient">The API Client to use</param>
    ...
    /// <summary>Enumerates all save game files available on the Dedicated Server.</summary>
    /// <remarks>Requires Admin privileges.</remarks>
    /// <param name="apiClient">The API Client to use</param>
    ...
    /// <summary>
    /// <para>Loads the save game file by name, optionally with Advanced Game Settings enabled.</para>
    /// <para>Dedicated Server HTTPS API will become temporarily unavailable when save game is being loaded.</para>
    /// </summary>
    /// <remarks>Requires Admin privileges.</remarks>
    /// <param name="apiClient">The API Client to use</param>
    ...
    /// <summary>
    /// <para>Uploads save game file to the Dedicated Server with the given name, and optionally immediately loads it.</para>
    /// <para>If save file is immediately loaded, Dedicated Server HTTPS API will become temporarily unavailable until save game is loaded.</para>
    /// </summary>
    /// <remarks>Requires Admin privileges.</remarks>
    /// <param name="apiClient">The API Client to use</param>
    ...
    /// <summary>Downloads save game with the given name from the Dedicated Server.</summary>
    /// <remarks>Requires Admin privileges.</remarks>
    /// <param name="apiClient">The API Client to use</param>
